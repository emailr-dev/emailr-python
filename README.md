...
* [get_current_workspace](docs/sdks/workspaces/README.md#get_current_workspace) - Identify the domain workspace bound to the current credential
...
* [`NotFoundError`](./src/emailr/errors/notfounderror.py): Template not found or no preview exists. Status code `404`. Applicable to 1 of 91 methods.*
* [`InternalServerError`](./src/emailr/errors/internalservererror.py): Workspace lookup failed. Status code `500`. Applicable to 1 of 91 methods.*
