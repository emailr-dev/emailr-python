...
SendEmailRequestToTypedDict = TypeAliasType(
    "SendEmailRequestToTypedDict", Union[str, List[str]]
)


SendEmailRequestTo = TypeAliasType("SendEmailRequestTo", Union[str, List[str]])


SendEmailRequestCcTypedDict = TypeAliasType(
    "SendEmailRequestCcTypedDict", Union[str, List[str]]
)
r"""CC recipients"""


SendEmailRequestCc = TypeAliasType("SendEmailRequestCc", Union[str, List[str]])
r"""CC recipients"""


SendEmailRequestBccTypedDict = TypeAliasType(
    "SendEmailRequestBccTypedDict", Union[str, List[str]]
)
r"""BCC recipients"""


SendEmailRequestBcc = TypeAliasType("SendEmailRequestBcc", Union[str, List[str]])
r"""BCC recipients"""


class SendEmailRequestTypedDict(TypedDict):
    to: SendEmailRequestToTypedDict
    ...
    cc: NotRequired[SendEmailRequestCcTypedDict]
    r"""CC recipients"""
    bcc: NotRequired[SendEmailRequestBccTypedDict]
    r"""BCC recipients"""
    ...
    r"""Inbox ID for sender identity defaults. When provided, Emailr can derive the inbox's name, from address, and reply-to address. If not provided, resolved from template's inbox_id."""
...
class SendEmailRequest(BaseModel):
    ...
    cc: Optional[SendEmailRequestCc] = None
    r"""CC recipients"""

    bcc: Optional[SendEmailRequestBcc] = None
    r"""BCC recipients"""
