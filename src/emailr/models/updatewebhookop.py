...
class UpdateWebhookRequestRequestTypedDict(TypedDict):
    id: str
    body: NotRequired[UpdateWebhookRequestTypedDict]


class UpdateWebhookRequestRequest(BaseModel):
    id: Annotated[
        str, FieldMetadata(path=PathParamMetadata(style="simple", explode=False))
    ]

    body: Annotated[
        Optional[UpdateWebhookRequest],
