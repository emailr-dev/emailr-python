...
class Workspaces(BaseSDK):
    def get_current_workspace(
        ...
        *,
    ...
    ) -> models.GetCurrentWorkspaceResponse:
        r"""Identify the domain workspace bound to the current credential
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.GetCurrentWorkspaceResponse, http_res)
    ...
    async def get_current_workspace_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
