...
class APIKeys(BaseSDK):
    def create(
        ...
        *,
        request: Optional[
            Union[models.CreateAPIKeyRequest, models.CreateAPIKeyRequestTypedDict]
        ] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, Optional[models.CreateAPIKeyRequest])
        request = cast(Optional[models.CreateAPIKeyRequest], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, True, "json", Optional[models.CreateAPIKeyRequest]
            ),
    ...
    def list(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.APIKeyListItem], http_res)
        if utils.match_response(http_res, "500", "application/json"):
            response_data = unmarshal_json_response(errors.ErrorData, http_res)
            raise errors.Error(response_data, http_res)
        if utils.match_response(http_res, "4XX", "*"):
