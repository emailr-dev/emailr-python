...
if TYPE_CHECKING:
    ...
    from .getcurrentworkspaceop import InternalServerError, InternalServerErrorData
...
_dynamic_imports: dict[str, str] = {
    ...
    "Error": ".error",
    "ErrorData": ".error",
    "InternalServerError": ".getcurrentworkspaceop",
    "InternalServerErrorData": ".getcurrentworkspaceop",
