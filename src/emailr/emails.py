...
class Emails(BaseSDK):
    ...
    def send(
        ...
        *,
        request: Optional[
            Union[models.SendEmailRequest, models.SendEmailRequestTypedDict]
        ] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, Optional[models.SendEmailRequest])
        request = cast(Optional[models.SendEmailRequest], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, True, "json", Optional[models.SendEmailRequest]
            ),
    ...
    def get(
        ...
        *,
        ...
        request = models.GetEmailRequest(
            id=id,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.Email, http_res)
    ...
    def list(
        ...
        *,
        ...
        request = models.ListEmailsRequest(
            page=page,
            limit=limit,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.ListEmailsResponse, http_res)
    ...
    def forward_email(
        ...
        *,
        request: Optional[
            Union[models.ForwardEmailRequest, models.ForwardEmailRequestTypedDict]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, Optional[models.ForwardEmailRequest])
        request = cast(Optional[models.ForwardEmailRequest], request)

        req = self._build_request(
            method="POST",
            path="/v1/emails/forward",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, True, "json", Optional[models.ForwardEmailRequest]
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
