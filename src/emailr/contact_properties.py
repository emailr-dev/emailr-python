...
class ContactProperties(BaseSDK):
        ...
        *,
        request: Optional[
            Union[
                ...
                models.CreatePropertyDefinitionRequestTypedDict,
            ]
        ] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, Optional[models.CreatePropertyDefinitionRequest]
            )
        request = cast(Optional[models.CreatePropertyDefinitionRequest], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.CreatePropertyDefinitionRequest],
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="createPropertyDefinition",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.PropertyDefinition, http_res)
    ...
    async def create_property_definition_async(
        self,
        *,
        request: Optional[
            Union[
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="listPropertyDefinitions",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.PropertyDefinition], http_res)
    ...
    def delete_property_definition(
        ...
        *,
        ...
        request = models.DeletePropertyDefinitionRequest(
            id=id,
        )

        req = self._build_request(
            method="DELETE",
            path="/v1/contact-properties/{id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="deletePropertyDefinition",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    async def delete_property_definition_async(
        self,
        *,
        id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
