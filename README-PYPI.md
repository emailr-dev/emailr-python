...
* [`NotFoundError`](https://github.com/emailr-dev/emailr-python/blob/master/./src/emailr/errors/notfounderror.py): Template not found or no preview exists. Status code `404`. Applicable to 1 of 55 methods.*
