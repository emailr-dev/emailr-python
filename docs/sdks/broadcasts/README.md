...
* [stop_broadcast](#stop_broadcast) - Stop broadcast
...
Stop a launched marketing campaign or sales sequence. Pending deliveries and future sequence steps are cancelled.

### Example Usage

<!-- UsageSnippet language="python" operationID="stopBroadcast" method="post" path="/v1/broadcasts/{id}/stop" -->
```python
from emailr import Emailr
import os
...
with Emailr(
    ...
    res = e_client.broadcasts.stop_broadcast(id="123e4567-e89b-12d3-a456-426614174000")
